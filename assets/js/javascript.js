...
updateActiveNavOnScroll();
  ...
  const traducoes = {
    pt: {
      ...
      'metrica.inscritos': 'Inscritos',
      'metrica.clientes': 'Clientes Satisfeitos',
      'metrica.projetos': 'Projetos Concluídos',
      'stats.projects': 'Projetos',
      'stats.experience': 'Experiência',
      'stats.experience.number': '1 anos',
      'sobre.heading': 'Sobre mim',
      'sobre.p1': 'Sou Felizardo Lázaro Matola, e tenho uma grande paixão por Tecnologia! Com apenas 21 anos, já tive a oportunidade incrível de participar de projetos que deixaram uma marca na minha jornada, como o desenvolvimento de um portfólio profissional pela Rocketseat. Essas experiências me mostraram a relevância de sempre inovar e me desafiar.',
      'sobre.p2': 'Agora Desenvolvo app web com sólida base em lógica de programação e estrutura de dados. Experiência prática no desenvolvimento de aplicações web responsivo, sistemas back-end e gerenciamento de bancos de dados utilizando TypeScript, Python, JavaScript, React, Figma, HTML5, CSS3 e SQL. Familiarizado com controlo de versão via Git e GitHub. Busco ingressar no mercado de trabalho como Desenvolvedor Full Stack e contribuir com equipas de tecnologia com foco em evolução contínua e soluções eficientes.',
      'sobre.p3': 'Trabalho em projetos em que atuo principalmente na parte de interfaces, onde desenvolvi uma excelente competência.',
      'sobre.cta': 'Veja meus projetos',
      'servicos.heading': 'O que eu faço',
      'servicos.intro': 'Minha paixão pela programação está em criar soluções que unem funcionalidade e beleza. Amo transformar ideias em realidade, seja desenvolvendo aplicações úteis, desenhando interfaces incríveis ou explorando novas possibilidades tecnológicas. Para mim, programar é mais que código; é a chance de mudar o mundo digital com criatividade e inovação.',
      'servicos.web.title': 'Web Design',
      'servicos.web.desc': 'Criação de websites modernos, responsivos e otimizados, com foco em performance e boa experiência para quem navega.',
      'servicos.app.title': 'App Design',
      'servicos.app.desc': 'Desenho de interfaces para aplicações móveis, pensadas para serem simples, intuitivas e agradáveis de usar.',
      'servicos.seo.title': 'SEO',
      'servicos.seo.desc': 'Otimização de sites para motores de busca, ajudando o teu negócio a ser encontrado mais facilmente online.',
      'servicos.uiux.title': 'UI/UX Design',
      'servicos.uiux.desc': 'Criação de interfaces modernas e experiências de utilizador centradas nas necessidades reais de quem usa o produto.',
      'cert.heading': 'Certificados e Formação',
      'cert1.title': 'Especialização Fullstack',
      'cert1.desc': 'Desenvolvimento de aplicações completas end-to-end com ecossistema React, Node.js e arquiteturas modernas.',
      ...
      'cert4.title': 'Tecnologia de Informação',
      'cert4.desc': 'Ainda a cursar, com conclusão prevista para 2030.',
      'cert5.title': 'Inglês — English Connect 2',
      'cert5.desc': 'Curso de inglês English Connect 2, com foco no desenvolvimento da fluência e comunicação no idioma.',
      'cert6.title': 'Tecnologia de Informação',
      'cert6.desc': 'Formação em Tecnologia de Informação, com base em fundamentos de informática e desenvolvimento de software.',
      'projetos.heading': 'Meus projetos',
      'projeto1.desc': 'Frontend, o protótipo foi traduzido em código utilizando HTML5, CSS3 e JavaScript, com Tailwind CSS como framework de estilização. Backend construída com Node.js e o framework Express, responsável por gerir as rotas da aplicação, a autenticação de utilizadores (visível no botão Entrar), o processamento de pedidos de serviços e a comunicação entre o cliente e a base de dados. PostgreSQL utilizado para armazenar informações como o catálogo de serviços, categorias, dados de utilizadores, histórico de trabalhos realizados e pedidos de contacto — garantindo integridade e escalabilidade à medida que a plataforma cresce.',
      'projeto2.desc': 'Blogue no formato de página de notícias, com o frontend desenvolvido em HTML5, CSS3 e JavaScript, utilizando Tailwind CSS como framework de estilização. Backend construído com Node.js e o framework Express, responsável por gerir as rotas da aplicação, a publicação e listagem de artigos, a organização por categorias e a comunicação entre o cliente e a base de dados. PostgreSQL utilizado para armazenar as notícias, categorias e dados relacionados, garantindo integridade e escalabilidade à medida que o conteúdo cresce.',
      'projeto3.desc': 'Site construído com React e TypeScript, garantindo uma interface fluida e um código mais seguro e fácil de manter graças à tipagem estática. Para a parte visual, foi utilizado Tailwind CSS, permitindo criar um design moderno, limpo e totalmente responsivo, adaptado tanto para computador como para telemóvel. O objetivo principal do projeto foi resolver um problema comum em barbearias: a dificuldade de organizar marcações manualmente, o que muitas vezes gera confusão de horários e perda de clientes. Com este site, o cliente pode agendar o seu horário em poucos cliques, e a barbearia ganha uma imagem mais profissional e moderna perante o público.',
      ...
      'footer.location.value': 'Beira, Moçambique',
    ...
    en: {
      ...
      'metrica.inscritos': 'Subscribers',
      'metrica.clientes': 'Happy Clients',
      'metrica.projetos': 'Completed Projects',
      'stats.projects': 'Projects',
      'stats.experience': 'Experience',
      'stats.experience.number': '1 years',
      'sobre.heading': 'About Me',
      'sobre.p1': "I'm Felizardo Lázaro Matola, and I have a great passion for Technology! At just 21 years old, I've already had the incredible opportunity to take part in projects that left a mark on my journey, such as building a professional portfolio through Rocketseat. These experiences showed me the importance of always innovating and challenging myself.",
      'sobre.p2': "I develop web applications with a solid foundation in programming logic and data structures. I have practical experience developing responsive web applications, back-end systems, and managing databases using TypeScript, Python, JavaScript, React, Figma, HTML5, CSS3, and SQL. I am also familiar with version control using Git and GitHub. I am seeking to enter the job market as a Full Stack Developer and contribute to technology teams focused on continuous improvement and efficient solutions.",
      'sobre.p3': "I work on projects where I mainly focus on the interface side, an area in which I've developed excellent skill.",
      'sobre.cta': 'See my projects',
      'servicos.heading': 'What I do',
      'servicos.intro': "My passion for programming lies in creating solutions that combine functionality and beauty. I love turning ideas into reality, whether by building useful applications, designing amazing interfaces, or exploring new technological possibilities. To me, programming is more than code; it's a chance to change the digital world with creativity and innovation.",
      'servicos.web.title': 'Web Design',
      'servicos.web.desc': 'Building modern, responsive, and optimized websites, focused on performance and a great browsing experience.',
      'servicos.app.title': 'App Design',
      'servicos.app.desc': 'Designing interfaces for mobile applications, made to be simple, intuitive, and enjoyable to use.',
      'servicos.seo.title': 'SEO',
      'servicos.seo.desc': 'Search engine optimization to help your business get found more easily online.',
      'servicos.uiux.title': 'UI/UX Design',
      'servicos.uiux.desc': 'Creating modern interfaces and user experiences centered on the real needs of the people using the product.',
      ...
      'cert4.title': 'Information Technology',
      'cert4.desc': 'Currently in progress, expected completion in 2030.',
      'cert5.title': 'English — English Connect 2',
      'cert5.desc': 'English Connect 2 course, focused on developing fluency and communication in the language.',
      'cert6.title': 'Information Technology',
      'cert6.desc': 'Studies in Information Technology, covering computing fundamentals and software development.',
      'projetos.heading': 'My Projects',
      'projeto1.desc': 'Frontend built from the prototype using HTML5, CSS3 and JavaScript, with Tailwind CSS as the styling framework. Backend built with Node.js and the Express framework, handling the application routes, user authentication (visible in the Sign In button), service request processing and communication between the client and the database. PostgreSQL was used to store information such as the service catalog, categories, user data, job history and contact requests — ensuring integrity and scalability as the platform grows.',
      'projeto2.desc': 'A blog in the format of a news page, with the frontend built using HTML5, CSS3 and JavaScript, with Tailwind CSS as the styling framework. Backend built with Node.js and the Express framework, handling the application routes, article publishing and listing, category organization and communication between the client and the database. PostgreSQL was used to store the news articles, categories and related data, ensuring integrity and scalability as the content grows.',
      'projeto3.desc': 'Site built with React and TypeScript, ensuring a smooth interface and safer, easier-to-maintain code thanks to static typing. For the visual side, Tailwind CSS was used, enabling a modern, clean and fully responsive design, adapted for both desktop and mobile. The main goal of the project was to solve a common problem for barbershops: the difficulty of organizing bookings manually, which often leads to schedule confusion and lost clients. With this site, the client can book an appointment in just a few clicks, and the barbershop gains a more professional and modern image with the public.',
      'skills.hard.heading': 'Hard Skills',
      'skills.soft.heading': 'Soft Skills',
      ...
      'footer.location.value': 'Beira, Mozambique',
