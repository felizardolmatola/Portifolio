...
updateActiveNavOnScroll();
  ...
  const traducoes = {
    pt: {
      ...
      'sobre.p2': 'Comecei a minha trajetória na programação com HTML, CSS e JavaScript, concentrando-me no front-end. Atualmente, sou um desenvolvedor fullstack com vivência na criação de aplicações completas, com backends que são seguros e escaláveis, além de interfaces que são modernas e intuitivas. Meu principal objetivo é desenvolver projetos que tenham um impacto positivo na vida das pessoas.',
    ...
    en: {
      ...
      'sobre.p2': "I started my journey in programming with HTML, CSS, and JavaScript, concentrating on the front-end. Today, I'm a fullstack developer experienced in building complete applications, with secure, scalable backends and modern, intuitive interfaces. My main goal is to develop projects that have a positive impact on people's lives.",
