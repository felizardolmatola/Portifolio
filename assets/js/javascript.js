...
updateActiveNavOnScroll();
  ...
  const traducoes = {
    pt: {
      ...
      'sobre.p1': 'Sou Lázaro Matola, também conhecido como Felizardo, e tenho uma grande paixão por tecnologia e programação! Com apenas 21 anos, já tive a oportunidade incrível de participar de projetos que deixaram uma marca na minha jornada, como o desenvolvimento de um portfólio profissional pela Rocketseat. Essas experiências me mostraram a relevância de sempre inovar e me desafiar.',
      'sobre.p2': 'Trabalho em projetos em que atuo principalmente na parte de interfaces, onde desenvolvi uma excelente competência. Comecei a minha trajetória na programação com HTML, CSS e JavaScript, concentrando-me no front-end. Atualmente, sou um desenvolvedor fullstack com vivência na criação de aplicações completas, com backends que são seguros e escaláveis, além de interfaces que são modernas e intuitivas. Meu principal objetivo é desenvolver projetos que tenham um impacto positivo na vida das pessoas.',
      ...
      'projeto1.desc': 'Página de receitas com funcionalidade para consultar todos os ingredientes da receita de um cupcake. O projeto foi desenvolvido utilizando HTML5 e CSS3 para o front-end e Figma para o design.',
      'projeto2.desc': 'Design Gráfico UX/UI.',
    ...
    en: {
      ...
      'sobre.p1': "I'm Lázaro Matola, also known as Felizardo, and I have a great passion for technology and programming! At just 21 years old, I've already had the incredible opportunity to take part in projects that left a mark on my journey, such as building a professional portfolio through Rocketseat. These experiences showed me the importance of always innovating and challenging myself.",
      'sobre.p2': "I work on projects where I mainly focus on the interface side, an area in which I've developed excellent skill. I started my journey in programming with HTML, CSS, and JavaScript, concentrating on the front-end. Today, I'm a fullstack developer experienced in building complete applications, with secure, scalable backends and modern, intuitive interfaces. My main goal is to develop projects that have a positive impact on people's lives.",
      ...
      'projeto1.desc': 'A recipe page with a feature to look up all the ingredients for a cupcake recipe. The project was built using HTML5 and CSS3 for the front-end and Figma for the design.',
      'projeto2.desc': 'UX/UI Graphic Design.',
